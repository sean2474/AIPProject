...
class FoodMenuEntries:
    ...
    def parse_until_unfilled_data_appears(self) -> Tuple[Dict[Tuple[Any, str], Dict[Any, Any]], Dict[str, str]]:
        ...
        for food_intake in ["breakfast", "lunch", "dinner"]:
            ...
            for day in range(0, 6):
                ...
                dict_key = (date, day_of_week(date))
        ...
        return daily_food_intakes, {"Start date": dates[0], "End date": dates[len(dates) - 1]}

    def get_parsed_data(self) -> Tuple[Dict[Tuple[Any, str], dict], Dict[str, str]]:
