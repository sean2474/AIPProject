        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    logging.error(f"Unable to get data about roster - {e}")
                ...
                for game in games:
                    ...
                    if len(game.text.split("\n")) < 2:
                        broken_game = True
                        logging.error(f"Invalid data had been gathered from {sport}, {category}")
                        continue
                ...
                if broken_game:
                    sys.stderr.write(f"[!] Wrong info gathered from {sport}, {category}\n")
